...
import { Program, Shader } from "@source/index";
...
function render(gl: WebGL2RenderingContext, program: Program, vertexArray: VertexArray) {
    gl.clearColor(1, 1, 0, 1.0);
    gl.clear(gl.COLOR_BUFFER_BIT);
